...
description: "Create the Shopify source config used by API-backed reconciliation runs and automations."
---
...
<Step title="Confirm the config is reusable">

Return to **Open Shopify Settings**. The saved config should appear on the settings surface.

The config is ready when a reconciliation run or automation can select Shopify as an API source.
