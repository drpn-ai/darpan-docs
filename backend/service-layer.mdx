...
- `create#Mapping`
- `save#Mapping`
- `list#Automations`, `get#Automation`, `save#Automation`, `delete#Automation`
- `pause#Automation`, `resume#Automation`, `run#AutomationNow`
- `list#AutomationExecutions`, `list#AutomationSourceOptions`

The full verified facade method list is in the [service catalog](/api-reference/service-catalog).
