...
Create or confirm the records the run will reuse. Search for the official setup surface you need: **Open SFTP Servers**, **Open NetSuite Settings**, **Open Shopify Settings**, **Open OMS Settings**, **Open AI Settings**, **Create Schema**, or **Open Schema Library**.

- SFTP for file exchange
- NetSuite, Shopify, and OMS for source-system integration flows
...
<Columns cols={2}>
  ...
  <Card title="Set up Shopify and OMS" icon="plug" href="/guides/setup-shopify-oms">
    Create source records for API-backed reconciliation and automation.
  </Card>
